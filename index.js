/**
 * ==========================================================================
 * 📂 VibeCoding Portfolio - Javascript Core (Updated)
 * --------------------------------------------------------------------------
 * 이 파일은 9개의 바이브코딩 프로젝트 데이터를 관리하고, 화면에 동적으로 카드를 그리는 스크립트입니다.
 * 
 * 💡 [개선 사항]
 * 1. "초등 사회 경제 지도안" 프로젝트가 삭제되었습니다.
 * 2. 제공해주신 실제 네이버 블로그 URL 4종이 연결되었습니다.
 * 3. 블로그 링크가 등록되지 않은 프로젝트는 사용자 인터페이스(카드 및 모달창)에서
 *    "블로그 보기" 버튼이 자동으로 숨겨지도록 지능적 예외 처리를 추가했습니다.
 * ==========================================================================
 */

// 1. 프로젝트 9종 데이터베이스 정의 (초등 사회 지도안 제외 및 실제 블로그 주소 연동)
const projects = [
    {
        id: 2, // 기존 ID를 유지하여 구분합니다.
        title: "바탕화면 투명 달력 위젯",
        category: "widget",
        ...
        blogUrl: "https://blog.naver.com/kfcman21/224322427336" // 연결 완료
    },
    {
        id: 3,
        title: "햄스터 로봇 조종기",
    ...
    },
    {
        ...
        blogUrl: "https://blog.naver.com/kfcman21/224308645434" // 연결 완료
    },
    {
        id: 5,
        ...
        blogUrl: "https://blog.naver.com/kfcman21/224329892022" // 연결 완료
    },
    {
        id: 6,
        title: "라쿤봇 카메라 손 제어기",
    ...
    },
    {
        ...
        blogUrl: "https://blog.naver.com/kfcman21/224322069875" // 연결 완료
    },
    {
        id: 10,
        title: "기타 및 개인 자료",
...
function renderProjects(filterCategory = "all") {
    ...
    filteredProjects.forEach(project => {
        ...
        const blogButtonHtml = project.blogUrl && project.blogUrl.trim() !== ""
            ...
            : ""; // 링크가 없으면 공백으로 처리하여 버튼을 아예 그리지 않음
...
window.openProjectModal = function(projectId) {
    ...
    if (project.blogUrl && project.blogUrl.trim() !== "") {
        ...
        modalBlogLink.style.display = "inline-flex"; // 버튼 보이기
    } else {
        modalBlogLink.href = "#";
        modalBlogLink.style.display = "none"; // 버튼 숨기기
    }
